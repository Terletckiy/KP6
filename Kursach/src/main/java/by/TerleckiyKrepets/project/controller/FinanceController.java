...
import by.TerleckiyKrepets.project.service.impl.FinanceServiceImpl;
...
public class FinanceController {
    ...
    public String finance(@RequestParam(value = "page", required = false, defaultValue = "0") int page, Model model) {
        ...
        model.addAttribute("users", list.getContent().stream()
                .filter(e -> !e.getAccount().getRole().equalsIgnoreCase("user"))
